...
//        SpecialModelLoaderEvents.LOAD_SCOPE.register(location -> LosGallysProps.MOD_ID.equals(location.getNamespace()));
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.FUSE_BOX, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.LAVA_LAMP, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CCTV, RenderLayer.getTranslucent());
        ...
        EntityRendererRegistry.register(ModBlockEntities.BENCH_ENTITY, ctx -> new EntityRenderer<>(ctx) {
            @Override
            public Identifier getTexture(BenchEntity entity) {
                return new Identifier(LosGallysProps.MOD_ID,"asphalt");
            }
        });
