...
public class RightHandRail extends HandRail {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext context) {
        ...
        return switch (dir) {
            case NORTH -> VoxelShapes.cuboid(0f, -0.5f, 0.8f, 1f, 1.5f, 1f);
            case EAST -> VoxelShapes.cuboid(0f, -0.5f, 0f, 0.2f, 1.5f, 1f);
            case SOUTH -> VoxelShapes.cuboid(0f, -0.5f, 0f, 1f, 1.5f, 0.2f);
            case WEST -> VoxelShapes.cuboid(0.8f, -0.5f, 0f, 1f, 1.5f, 1f);
