...
public class Window extends HorizontalFacingBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return getDefaultState().with(FACING, ctx.getPlayerFacing().getOpposite())
                .with(TOP_STATE, world.getBlockState(pos.offset(Direction.UP)).getBlock() instanceof Window && world.getBlockState(pos.offset(Direction.UP)).get(FACING) == ctx.getPlayerFacing().getOpposite())
                .with(BOTTOM_STATE, world.getBlockState(pos.offset(Direction.DOWN)).getBlock() instanceof Window && world.getBlockState(pos.offset(Direction.DOWN)).get(FACING) == ctx.getPlayerFacing().getOpposite());
    }
}
