...
public class CustomDoorRenderer extends GeoBlockRenderer<CustomDoorEntity> {
    public CustomDoorRenderer(BlockEntityRendererFactory.Context context) {
        super(new CustomDoorModel());
    }

    @Override
    public RenderLayer getRenderType(CustomDoorEntity animatable, float partialTick, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, Identifier texture) {
