...
public class ModBlockEntities {
    ...
    public static BlockEntityType<PowerElementsEntity> POWER_ELEMENTS_ENTITY = FabricBlockEntityTypeBuilder.create(PowerElementsEntity::new, ModBlocks.FUSE_BOX_TYPE_1).build(null);
