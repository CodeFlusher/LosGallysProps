...
public class ModItems {
    ...
    public static void registerItems() {
        InformativeLogger.debugMessage("Registering Items");
        InformativeLogger.debugMessage("MCE");
        ...
        InformativeLogger.debugMessage("GLD");
        ...
        InformativeLogger.debugMessage("CONFIGURATOR");
